...
class RGrass1(PositionNode):
    def __init__(
        ...
        self.__idle_0_anim = pyglet.image.Animation.from_image_sequence([pyglet.resource.image("sprites/rughai/prop/grass_1/grass_1_idle_0.png")], 1.0)
        self.__idle_1_anim = pyglet.resource.animation("sprites/rughai/prop/grass_1/grass_1_idle_1.gif")
