...
class RVeg0(PositionNode):
    def __init__(
        ...
        self.__idle_0_anim = pyglet.image.Animation.from_image_sequence([pyglet.resource.image("sprites/rughai/prop/veg_0/veg_0_idle_0.png")], 1.0)
        self.__idle_1_anim = pyglet.resource.animation("sprites/rughai/prop/veg_0/veg_0_idle_1.gif")
